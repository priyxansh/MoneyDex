...
-- CreateIndex
CREATE UNIQUE INDEX "UserOAuthProvider_provider_providerUserId_userId_key" ON "UserOAuthProvider"("provider", "providerUserId", "userId");

-- AddForeignKey
ALTER TABLE "UserOAuthProvider" ADD CONSTRAINT "UserOAuthProvider_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
